        ...
        <div className="container mx-auto px-6 py-20 relative z-10">
          ...
          >
            ...
            >
              ...
              innovative solutions and building exceptional web experiences. Explore my projects and academic journey below.
            </motion.p>
          </motion.div>
        </div>
      </div>
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-8">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-base" style={{ color: '#29353c' }}>
                      <span className="font-medium">Double Major:</span> Computer Science & Robotics
                    </p>
                  </div>
                </div>
